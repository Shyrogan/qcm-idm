...
import qcm.dsl.formatting2.DSLFormatter;
import qcm.dsl.generator.DSLGenerator;
import qcm.dsl.parser.antlr.DSLAntlrTokenFileProvider;
import qcm.dsl.parser.antlr.DSLParser;
import qcm.dsl.parser.antlr.internal.InternalDSLLexer;
import qcm.dsl.scoping.DSLScopeProvider;
import qcm.dsl.serializer.DSLSemanticSequencer;
import qcm.dsl.serializer.DSLSyntacticSequencer;
import qcm.dsl.services.DSLGrammarAccess;
import qcm.dsl.validation.DSLConfigurableIssueCodesProvider;
import qcm.dsl.validation.DSLValidator;
...
public abstract class AbstractDSLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "qcm/dsl/DSL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("qcm.dsl.DSL");
	}
